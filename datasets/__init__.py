...
from .general_eval_tnt import MVSDataset as TNTDataset
...
def get_loader(args, listfile, mode="train"):
    ...
    elif args.dataset_name == "tnt_eval":
        dataset = TNTDataset(args, listfile, mode)
    else:
    ...
    data_loader = data.DataLoader(dataset, args.batch_size, sampler=sampler, num_workers=4, drop_last=(mode == "train"), pin_memory=False)
