...
parser.add_argument('--root_path', type=str, default="/home/lida/lida/2Ddataset/dtu_data/DTU/dtu_test")
...
parser.add_argument('--prob_thresh', type=float, default=0.95)  
...
def load_data(root_path, depth_path, scene_name, thresh):
    ...
    for view in range(49):
        img_filename = "{}/{}/images/{:08d}.png".format(depth_path, scene_name, view)
