...
parser.add_argument('--plydir', default='./outputs/dtu/jiayou_test/pcd_fusion_plys_cl/', help='output dir')
...
parser.add_argument('--depth_thres', type=float, default=0.001, help='depth_thres for pcd')  # 0.001
