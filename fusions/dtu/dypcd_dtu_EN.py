...
parser.add_argument('--testpath', default='/home/liyi/dataset/dtu_data/dtu-test-1200', help='testing data dir for some scenes')
...
parser.add_argument('--logdir', default='./experiment/dtu/jiayou', help='the directory to save checkpoints/logs')
...
parser.add_argument('--conf', type=float, nargs='+', default=0.55, help='prob confidence, for pcd and dypcd')  # [0.1, 0.1, 0.15, 0.5]
